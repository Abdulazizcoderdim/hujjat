  ...
  // ============ OPERATOR-only section ============
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/library/all-books",
        icon: BookOpen,
        roles: [UserRole.OPERATOR],
      },
      {
        title: "QR yorliqlar",
        href: "/library/qr-labels",
        icon: QrCode,
        roles: [UserRole.OPERATOR],
      },
    ],
    ...
    items: [
      {
        ...
        children: [
          ...
          { title: "Hodimlar", href: "/users/employees", icon: Briefcase },
    ...
    items: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            href: "/library/curriculum-books",
            icon: GraduationCap,
          },
          {
            title: "Posterlarni qayta yaratish",
            href: "/library/regenerate-posters",
            icon: Upload,
          },
          {
            title: "QR yorliqlar",
...
export const PATH_TITLES: Record<string, string> = {
  ...
  "/library/curriculum-books": "O'quv reja kitoblari",
  "/library/all-books": "Barcha kitoblar",
  "/library/regenerate-posters": "Posterlarni qayta yaratish",
  "/library/qr-labels": "QR yorliqlar",
  "/audit": "Audit",
