              ...
              <AnimatePresence>
                {searchValue && (
                  <motion.button
                    ...
                    className="absolute right-3 sm:right-4 top-4 -translate-y-1/2 w-6 h-6 flex items-center justify-center rounded-full bg-secondary hover:bg-border transition-colors"
                  >
                    <X
