        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              type="submit"
              className="w-full h-12 text-center flex items-center justify-center bg-primary text-primary-foreground rounded-xl font-semibold text-sm hover:opacity-90 active:scale-[0.98] transition-all"
            >
              {authLoading ? (
